...
module Kitchen
  module Driver
    ...
    class Docker < Kitchen::Driver::Base
      ...
      default_config :image do |driver| # rubocop:disable Style/SymbolProc TODO
      ...
      default_config :platform do |driver| # rubocop:disable Style/SymbolProc TODO
      ...
      def wait_for_transport(state)
        if config[:wait_for_transport]
          instance.transport.connection(state) do |conn| # rubocop:disable Style/SymbolProc TODO
